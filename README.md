...
previous generation LGA1366 required dual CPU's X5690 to have 12-Cores / 24-Threads in a single board, </br>
pga775 required 2x QX9775 CPU's to allow a board with 8-cores. </br>

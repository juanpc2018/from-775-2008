...
45% Multi-Thread. </br>
The Advantage / The Goal of the E5-v2 CPU was to combine 12-cores in a Single CPU, </br>
instead previous generation required dual CPU X5690 to have 12-Cores / 24-Threads. </br>
and 775 QX9775 required 2x CPUs to have 8-cores. </br>

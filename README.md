...
Apple had a G5 Quad-core in (2005), but was 2x PPC6 dual-core 970MP CPU's, Not a single Quad-core CPU, </br>
its possible to measure performance between different architectures & OS, to have an idea </br>
using software: like Whetstones, Dhrystones, or Cinebench 2003 G5 optimized & G4 vs. Win. </br>
...
i7-930 has a Gain of 1.37x in Multi-Thread "Single-core loss in All Cores + Hyper Threading Gain" </br>
...
Not a -50% power consumption reduction clock speed vs. clock speed, but... </br>
E5-2697v2 has a slight performance boost vs. i7-990x / X5690 / W3690 </br>
a +6.3% in Single-core with a slight lower clock speed -0.23GHz. </br>
